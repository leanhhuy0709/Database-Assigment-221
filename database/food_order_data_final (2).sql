...
INSERT INTO `Food` values(
							1, 1, 4 , 'cơm sườn bì', 30000, '1 suon+bi', 1,'M'),(
							1, 2, 4, 'cơm sườn bì trứng', 40000, '1 suon+1 trung+bi', 1,'M'),(
							1, 3, 4 , 'cơm sườn bì chả', 50000, '1 suon+bi+1 cha', 1,'M'),(
							1, 4 , 4 , 'cơm sườn bì', 40000, '1 suon to+bi', 1,'L'),(
							1, 5, 4, 'cơm sườn bì trứng', 50000, '1 suon to+1 trung+bi', 1,'L'),(
							1, 6 , 4 , 'cơm sườn bì chả', 60000, 'suon to+bi+cha', 1,'L'),(
							1, 7 , 2 , 'bún riêu',  25000, NULL, 1,'M'),(
							1, 8 , 2 , 'bún riêu', 40000, NULL, 1,'L'),(
							1, 9 , 2 , 'hủ tiếu', 30000, NULL , 1,'M'),(
							1, 10, 2, 'hủ tiếu' , 35000,  NULL , 1,'L'),(
							...
							2, 1 , 6 , 'trà sữa dac biet', 45000, '7 loai topping', 1,'M'),(
							2, 2, 6, 'trà sữa truyền thống kem trứng nướng', 42000, 'da bao gom chan trau trang', 1,'M'),(
							2, 3 , 6 , 'trà sữa olong', 42000, 'da bao gom tran chau den', 1,'M'),(
							2, 4 , 6 , 'trà sữa gạo rang', 40000, 'da bao gom tran chau trang', 1,'M'),(
							2, 5, 6, 'trà sữa hoa nhài', 35000, NULL, 1,'M'),(
							2, 6 , 6 , 'trà sữa socola', 40000, 'da bao gom tran chau den', 1,'M'),(
							2, 7 , 6 , 'trà sữa khoai môn',  40000, NULL, 1,'M'),(
							2, 8 , 6 , 'trà sữa bạc hà', 40000, NULL, 1,'M'),(
							2, 9 , 6 , 'trà sữa dâu', 40000, NULL , 1,'M'),(
							2, 10, 6, 'trà sữa thái xanh' , 40000,  NULL , 1,'M'),(
							2, 11, 6, 'trà sữa truyền thống kem trứng nướng', 47000, 'da bao gom chan trau trang', 1,'L'),(
							2, 12, 6 , 'trà sữa olong', 47000, 'da bao gom tran chau den', 1,'L'),(
							2, 13 , 6 , 'trà sữa gạo rang', 45000, 'da bao gom tran chau trang', 1,'L'),(
							2, 14, 6, 'trà sữa hoa nhài', 40000, NULL, 1,'L'),(
							2, 15 , 6 , 'trà sữa socola', 45000, 'da bao gom tran chau den', 1,'L'),(
							2, 16 , 6 , 'trà sữa khoai môn',  45000, NULL, 1,'L'),(
							2, 17 , 6 , 'trà sữa bạc hà', 45000, NULL, 1,'L'),(
							2, 18 , 6 , 'trà sữa dâu', 45000, NULL , 1,'L'),(
							2, 19, 6, 'trà sữa thái xanh' , 45000,  NULL , 1,'L'),(
